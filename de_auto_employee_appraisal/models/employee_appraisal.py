    ...
    def create_auto_appraisal_record(self, records):
        ...
        for record in records:
            ...
            for employee in employees:
                if employee.confirm_date < date.today():
#                     raise UserError(employee.confirm_date)
                    vals={
                    ...
                    hr_aprsl_obj = self.env['hr.appraisal'].create(vals)
                    appraisal_objectives = self.env['hr.appraisal.objective'].search([
                        ('employee_id', '=', employee.id),('objective_year','=',record.target_year)])
                    ...
                    if not appraisal_objectives:
                        ...
                        vals = {
                            ...
                            'res_id': hr_aprsl_obj.id,  
                            'activity_type_id': activity_type.id,
                            'summary': 'Appraisal Objective Alert!',
