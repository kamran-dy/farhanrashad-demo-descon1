...
#             attachment_data = kw.get('attachment_id')
#             attachment_object = json.loads(kw.get('attachment_id'))
#             attachment_id = Attachments.create({

#             'name': attachment_object.filename,

#             'type': 'binary',

#             'datas': base64.b64encode(attachment_object.read()),
