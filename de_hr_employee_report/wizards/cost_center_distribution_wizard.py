...
class CostCenterDistribution(models.TransientModel):
    _name = 'cost.center.distribution'
    _description = 'Cost Center Distribution'
...
#             employee_type_names.append(ids.name)
        ...
        return self.env.ref('de_hr_employee_report.action_report_cost_center_distribution').report_action(self, data=data)
...
#             employee_type_names.append(ids.name)
        data = {
            ...
            'location_ids': self.location_ids.ids,
            'cost_center_ids': self.cost_center_ids.ids, }
        return self.env.ref('de_hr_employee_report.view_cost_center_distribution_report_xlsx').report_action(self, data=data)
