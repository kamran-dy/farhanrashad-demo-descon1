...
class CreateLoanRequest(http.Controller):
    ...
    def edit_loan(self, **kw):
        ...
        return request.render("de_portal_loan_request.update_loan_request_submited", {})
...
class CustomerPortal(CustomerPortal):
    ...
    @http.route(['/loan/edit/<int:loan_id>'], type='http', auth="public", website=True)
    def compute_loan_nstallment(self,loan_id , access_token=None, **kw):
        id=loan_id
        record = request.env['hr.loan'].sudo().browse(id)
        ...
        return request.render("de_portal_loan_request.edit_loan", values)
