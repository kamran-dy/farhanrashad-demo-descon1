...
class HrUserAttendance(models.Model):
                            ...
                            if existing_attendance:
                                ...
                                if delta1a < 600 :
                                    ...
                                    if edeltain <= 57600:
                                        ...
                                        hr_attendance.action_process_attendance(hr_attendance.id)
                                        check_in = attendace.timestamp
                                        attendace.update({
                                                   'is_attedance_created' : True
                                                        })  
    ...
    def action_process_attendace_validated(self, process_num):
        
        month_datetime = fields.date.today() - timedelta(process_num)
        for month_date in range(1):
            datetime =  month_datetime + timedelta(month_date)
            date_start = datetime + relativedelta(hours =+ 0)
            date_end = datetime + relativedelta(hours =+ 23.99)
